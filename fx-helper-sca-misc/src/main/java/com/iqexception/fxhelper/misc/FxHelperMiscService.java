...
public class FxHelperMiscService {
    public static void main(String[] args) throws UnknownHostException {
        ...
        SpringApplication.run(FxHelperMiscService.class, args);
    }
}

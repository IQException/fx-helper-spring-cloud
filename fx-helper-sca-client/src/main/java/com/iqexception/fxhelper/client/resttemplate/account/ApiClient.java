...
package com.iqexception.fxhelper.client.resttemplate.account;
...
import com.iqexception.fxhelper.client.resttemplate.account.auth.Authentication;
...
@Component("com.iqexception.fxhelper.client.resttemplate.account.ApiClient")
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "http://fx-helper-account";

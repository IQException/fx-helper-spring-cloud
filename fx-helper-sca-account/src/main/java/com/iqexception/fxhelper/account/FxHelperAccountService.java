...
public class FxHelperAccountService {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        SpringApplication.run(FxHelperAccountService.class, args);
    }
}

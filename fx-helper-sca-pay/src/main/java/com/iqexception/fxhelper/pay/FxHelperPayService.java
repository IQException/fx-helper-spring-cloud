...
public class FxHelperPayService {
    public static void main(String[] args) throws UnknownHostException {
        ...
        SpringApplication.run(FxHelperPayService.class, args);
    }
}

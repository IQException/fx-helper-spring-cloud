...
public class FxHelperOrderService {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        SpringApplication.run(FxHelperOrderService.class, args);
    }
}

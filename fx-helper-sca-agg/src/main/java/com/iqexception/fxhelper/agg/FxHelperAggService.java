...
public class FxHelperAggService {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        SpringApplication.run(FxHelperAggService.class, args);
    }
}

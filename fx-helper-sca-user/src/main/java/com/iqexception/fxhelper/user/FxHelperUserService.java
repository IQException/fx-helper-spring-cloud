...
public class FxHelperUserService {
    public static void main(String[] args) throws UnknownHostException {
        ...
        SpringApplication.run(FxHelperUserService.class, args);
    }
}
